            ...
            >
                ...
                <div className="flex flex-wrap gap-2">
                    {['HTML5', 'CSS3', 'JavaScript', 'ReactJS', 'TypeScript', 'Bootstrap', 'MySQL', 'Python'].map((skill) => (
                        <motion.span variants={item} key={skill} className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-sm text-gray-300 hover:border-blue-400 hover:text-blue-400 transition-colors cursor-default">
                            {skill}
                        </motion.span>
                    ))}
                </div>
            ...
            >
                ...
                <div className="flex flex-wrap gap-2">
                    {['UX Design', 'UI Design', 'Figma', 'Responsive Design', 'Product Design'].map((skill) => (
                        <motion.span variants={item} key={skill} className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-sm text-gray-300 hover:border-pink-400 hover:text-pink-400 transition-colors cursor-default">
                            {skill}
                        </motion.span>
                    ))}
                </div>
            ...
            >
                ...
                <div className="flex flex-wrap gap-2">
                    {['SEO Technical', 'SEM', 'Google Analytics 4', 'Search Console', 'Google Ads', 'Ahrefs', 'Screaming Frog', 'Prompt Engineering'].map((skill) => (
                        <motion.span variants={item} key={skill} className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-sm text-gray-300 hover:border-purple-400 hover:text-purple-400 transition-colors cursor-default">
                            {skill}
                        </motion.span>
                    ))}
                </div>
             ...
             <motion.div 
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="glass-panel p-6 rounded-2xl md:col-span-2 lg:col-span-3"
            >
                <div className="flex items-center mb-6">
